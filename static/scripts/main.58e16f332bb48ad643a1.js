/*! For license information please see main.58e16f332bb48ad643a1.js.LICENSE.txt */
(() => {
	'use strict';
	var e = {
			20: (e, n, t) => {
			...
			287: (e, n) => {
				...
				function C(e, n, r) {
					...
					if (null != n)
						...
						n))
							_.call(n, l) && !x.hasOwnProperty(l) && (a[l] = n[l]);
			...
			551: (e, n, t) => {
				...
				function Ce(e) {
					if ((e = bl(e))) {
						...
						var n = e.stateNode;
						n && ((n = kl(n)), _e(e.stateNode, e.type, n));
					}
				}
				function Ee(e) {
				...
				function Kn(e, n, t, r) {
					if ($n) {
						var l = Yn(e, n, t, r);
						if (null === l) Vr(e, n, r, Gn, t), On(e, r);
						else if (
							(function (e, n, t, r, l) {
								switch (n) {
									case 'focusin':
									...
									case 'pointerover':
										var a = l.pointerId;
										return Fn.set(a, Dn(Fn.get(a) || null, e, n, t, r, l)), !0;
									case 'gotpointercapture':
										return (
											(a = l.pointerId),
							...
							for (; null !== l; ) {
								...
								if (
									(null !== a && _n(a),
									null === (a = Yn(e, n, t, r)) && Vr(e, n, r, Gn, t),
									a === l)
								)
									break;
								l = a;
							...
							b &&
								(Dt &&
									...
									(Bt || 'onCompositionStart' !== b
										...
										: ((Jn = 'value' in (Xn = l) ? Xn.value : Xn.textContent),
										  (Bt = !0))),
								0 < (g = Qr(r, b)).length &&
				...
				function Qr(e, n) {
					for (var t = n + 'Capture', r = []; null !== e; ) {
						...
						5 === l.tag &&
							null !== a &&
							((l = a),
							null != (a = Fe(e, t)) && r.unshift($r(e, a, l)),
							null != (a = Fe(e, n)) && r.push($r(e, a, l))),
							(e = e.return);
					}
					return r;
				}
				...
				function Kr(e, n, t, r, l) {
					for (var a = n._reactName, o = []; null !== t && t !== r; ) {
						...
						5 === i.tag &&
							...
							((i = s),
							l
								? null != (u = Fe(t, a)) && o.unshift($r(t, u, i))
								: l || (null != (u = Fe(t, a)) && o.push($r(t, u, i)))),
							(t = t.return);
					}
				...
				function Cl(e) {
					0 > Sl || ((e.current = _l[Sl]), (_l[Sl] = null), Sl--);
				}
				function El(e, n) {
					Sl++, (_l[Sl] = e.current), (e.current = n);
				}
				var Nl = {},
					zl = xl(Nl),
					Pl = xl(!1),
				...
				function Bl() {
					if (!Al && null !== jl) {
						...
						try {
							...
							throw (null !== jl && (jl = jl.slice(e + 1)), qe(Je, Bl), n);
						} finally {
							(wn = n), (Al = !1);
						}
					}
				...
				var Wl = [],
					...
					Zl = '';
				function Xl(e, n) {
					(Wl[Vl++] = Ql), (Wl[Vl++] = $l), ($l = e), (Ql = n);
				}
				function Jl(e, n, t) {
					(ql[Kl++] = Yl), (ql[Kl++] = Zl), (ql[Kl++] = Gl), (Gl = e);
					var r = Yl;
					e = Zl;
					var l = 32 - on(r) - 1;
					(r &= ~(1 << l)), (t += 1);
				...
				function na(e) {
					for (; e === $l; )
						($l = Wl[--Vl]), (Wl[Vl] = null), (Ql = Wl[--Vl]), (Wl[Vl] = null);
					for (; e === Gl; )
						(Gl = ql[--Kl]),
							(ql[Kl] = null),
							(Zl = ql[--Kl]),
					...
					switch (e.tag) {
						...
						case 13:
							return (
								...
								((t = null !== Gl ? { id: Yl, overflow: Zl } : null),
								(e.memoizedState = {
									dehydrated: n,
									treeContext: t,
				...
				function ba(e) {
					...
					function s(e, n, t, r) {
						...
						return a === S
							...
							: (((r = Is(t.type, t.key, t.props, null, e.mode, r)).ref = va(
									e,
									n,
									t
							  )),
					...
					function d(e, n, t) {
						...
						if ('object' == typeof n && null !== n) {
							switch (n.$$typeof) {
								case k:
									return (
										((t = Is(n.type, n.key, n.props, null, e.mode, t)).ref = va(
											e,
											null,
											n
										)),
					...
					function h(l, a, i, u) {
						...
						if (h === i.length) return t(l, f), la && Xl(l, h), s;
						if (null === f) {
							for (; h < i.length; h++)
								null !== (f = d(l, i[h], u)) &&
									((a = o(f, a, h)),
					...
					function v(l, i, u, s) {
						...
						if (y.done) return t(l, h), la && Xl(l, v), c;
						if (null === h) {
				...
				function Ga(e, n) {
					switch ((El(qa, n), El(Qa, e), El($a, Va), (e = n.nodeType))) {
						case 9:
						case 11:
				...
				function ko(e) {
					...
					if (null !== (e = t.interleaved)) {
						l = e;
						do {
							(o = l.lane), (oo.lanes |= o), (Ou |= o), (l = l.next);
						} while (l !== e);
				...
				function xo(e, n) {
					...
					if (
						...
						if (
							((t.flags |= 2048),
							To(9, Eo.bind(null, t, r, l, n), void 0, null),
							null === Pu)
						)
							throw Error(a(349));
						30 & ao || Co(t, n, l);
				...
				function Ro(e, n, t, r) {
					var l = yo();
					(oo.flags |= e),
						(l.memoizedState = To(1 | n, t, void 0, void 0 === r ? null : r));
				}
				function Io(e, n, t, r) {
					var l = bo();
					r = void 0 === r ? null : r;
					...
					if (null !== io) {
						...
						if (((a = o.destroy), null !== r && ho(r, o.deps)))
							return void (l.memoizedState = To(n, t, a, r));
					}
					(oo.flags |= e), (l.memoizedState = To(1 | n, t, a, r));
				}
				function Mo(e, n) {
				...
				function Vo(e, n, t) {
					return 21 & ao
						? (ir(t, n) ||
								((t = vn()), (oo.lanes |= t), (Ou |= t), (e.baseState = !0)),
						  n)
					...
					Jo = {
						...
						useTransition: function () {
							var e = Lo(!1),
								n = e[0];
							return (
								(e = $o.bind(null, e[1])), (yo().memoizedState = e), [n, e]
							);
						},
						...
						useSyncExternalStore: function (e, n, t) {
							...
							return (
								...
								(r.flags |= 2048),
								To(9, Eo.bind(null, r, o, t, n), void 0, null),
								t
							);
						},
						useId: function () {
				...
				function ui(e, n, t, r) {
					...
					'object' == typeof a && null !== a
						? (l.context = La(a))
						: ((a = Fl(n) ? Ll : zl.current), (l.context = Tl(e, a))),
				...
				function Si(e, n, t, r, l) {
					if (null !== e) {
						...
						if (ur(a, r) && e.ref === n.ref) {
							if (((bi = !1), (n.pendingProps = r = a), !(e.lanes & l)))
				...
				function Ni(e, n, t, r, l) {
					...
					if ((Pa(n, l), null === n.stateNode))
						Wi(e, n), oi(n, t, r), ui(n, t, r, l), (r = !0);
					else if (null === e) {
						var o = n.stateNode,
							i = n.memoizedProps;
						o.props = i;
				...
				function zi(e, n, t, r, l, a) {
					Ci(e, n);
					var o = !!(128 & n.flags);
					if (!r && !o) return l && Dl(n, t, !1), Vi(e, n, a);
							...
							if (t)
								return 256 & n.flags
									...
									: ((o = r.fallback),
									  ...
									  (r.sibling = o),
									  (n.child = r),
									  1 & n.mode && wa(n, e.child, null, i),
									  (n.child.memoizedState = Oi(i)),
									  (n.memoizedState = Mi),
									  o);
							if (!(1 & n.mode)) return Ui(e, n, i, null);
							if ('$!' === l.data) {
							...
							if (((u = !!(i & e.childLanes)), bi || u)) {
								if (null !== (r = Pu)) {
									...
									0 !== (l = l & (r.suspendedLanes | i) ? 0 : l) &&
										l !== o.retryLane &&
										((o.retryLane = l), Ia(e, l), ts(r, e, l, -1));
								}
								return hs(), Ui(e, n, i, (r = ci(Error(a(421)))));
							}
							return '$?' === l.data
								? ((n.flags |= 128),
								  (n.child = e.child),
				...
				function Bi(e, n, t) {
					var r = n.pendingProps,
						l = r.revealOrder,
						a = r.tail;
					if ((wi(e, n, r.children, t), 2 & (r = Ja.current)))
						(r = (1 & r) | 2), (n.flags |= 128);
					else {
						...
						case 6:
							if (e && null != n.stateNode) Ii(e, n, e.memoizedProps, r);
								...
								if ('string' != typeof r && null === n.stateNode)
									throw Error(a(166));
								if (((t = Ka(qa.current)), Ka($a.current), fa(n))) {
									if (
										((r = n.stateNode),
										(t = n.memoizedProps),
										(r[dl] = n),
											...
											if (null !== (u = eo(e))) {
												for (
													...
													(e = r),
														...
														(t = t.sibling);
												return El(Ja, (1 & Ja.current) | 2), n.child;
											}
											e = e.sibling;
										}
									null !== o.tail &&
									...
									for (Xi = l; null !== Xi; )
										(u = (o = Xi).child),
											22 === o.tag && null !== o.memoizedState
												...
												? ((u.return = o), (Xi = u))
												: _u(l);
								for (; null !== a; ) (Xi = a), bu(a, n, t), (a = a.sibling);
								(Xi = l), (Gi = i), (Yi = s);
							}
							wu(e);
						} else
				...
				function ls(e, n) {
					if (((Xu = -1), (Ju = 0), 6 & zu)) throw Error(a(327));
					var t = e.callbackNode;
					...
					if (0 !== n) {
						if (
							...
							throw ((t = Mu), ds(e, 0), is(e, r), rs(e, Ze()), t);
						if (6 === n) is(e, r);
						else {
							if (
							...
							switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
								...
								case 3:
									if (
										...
										e.timeoutHandle = rl(ks.bind(null, e, Au, Wu), n);
										break;
									}
									ks(e, Au, Wu);
									break;
								case 4:
									...
									if (
										...
										e.timeoutHandle = rl(ks.bind(null, e, Au, Wu), r);
										break;
									}
									ks(e, Au, Wu);
									break;
					...
					return rs(e, Ze()), e.callbackNode === t ? ls.bind(null, e) : null;
				}
				function as(e, n) {
					var t = Uu;
					return (
				...
				function us(e) {
					...
					_s();
					var n = pn(e, 0);
					if (!(1 & n)) return rs(e, Ze()), null;
					var t = vs(e, n);
					if (0 !== e.tag && 2 === t) {
						var r = hn(e);
						0 !== r && ((n = r), (t = as(e, r)));
					}
					if (1 === t) throw ((t = Mu), ds(e, 0), is(e, n), rs(e, Ze()), t);
				...
				function ss(e, n) {
					...
					try {
						...
						0 === (zu = t) && ((Bu = Ze() + 500), Ul && Bl());
					}
				}
				function cs(e) {
					null !== Ku && 0 === Ku.tag && !(6 & zu) && _s();
					var n = zu;
					zu |= 1;
					var t = Nu.transition,
						r = wn;
					try {
						...
						(wn = r), (Nu.transition = t), !(6 & (zu = n)) && Bl();
					}
				}
				function fs() {
					(Fu = Ru.current), Cl(Ru);
				...
				function ms() {
					var e = Cu.current;
					return (Cu.current = Xo), null === e ? Xo : e;
				}
				function hs() {
					(0 !== Iu && 3 !== Iu && 2 !== Iu) || (Iu = 4),
						null === Pu ||
				...
				function vs(e, n) {
					...
					if ((Ea(), (zu = t), (Cu.current = r), null !== Lu))
						throw Error(a(261));
					return (Pu = null), (Tu = 0), Iu;
				}
				function gs() {
					for (; null !== Lu; ) bs(Lu);
				}
				...
				function ws(e) {
					...
					do {
						...
						} else if (null !== (t = qi(t, n, Fu))) return void (Lu = t);
				...
				function Hs(e) {
					...
					if (1 === e.tag) {
						var t = e.type;
						if (Fl(t)) return Ml(e, t, n);
					}
					return n;
				}
				function Bs(e, n, t, r, l, a, o, i, u) {
					return (
						((e = As(t, r, !0, e, 0, a, 0, i, u)).context = Hs(null)),
						(t = e.current),
						((a = ja((r = es()), (l = ns(t)))).callback = null != n ? n : null),
						Ua(t, a, l),
						(e.current.lanes = l),
						yn(e, l, r),
						rs(e, r),
				...
				Su = function (e, n, t) {
									...
									(function (e, n, t) {
										switch (n.tag) {
											...
											case 10:
												...
												El(_a, r._currentValue), (r._currentValue = l);
												break;
											case 13:
												if (null !== (r = n.memoizedState))
													return null !== r.dehydrated
														? (El(Ja, 1 & Ja.current), (n.flags |= 128), null)
					...
					else (bi = !1), la && 1048576 & n.flags && Jl(n, Ql, n.index);
					switch (((n.lanes = 0), n.tag)) {
						case 2:
							var r = n.type;
							Wi(e, n), (e = n.pendingProps);
							var l = Tl(n, zl.current);
							Pa(n, t), (l = vo(null, n, r, e, l, t));
							var o = go();
							return (
								(n.flags |= 1),
								'object' == typeof l &&
						...
						case 0:
							return (
								(r = n.type),
								(l = n.pendingProps),
								Ei(e, n, r, (l = n.elementType === r ? l : ti(r, l)), t)
							);
						case 1:
							return (
								(r = n.type),
							...
							e: {
								...
								if (((r = i.element), o.isDehydrated)) {
									if (
										...
										n = Li(e, n, r, t, (l = si(Error(a(423)), n)));
										break e;
									}
									if (r !== l) {
										n = Li(e, n, r, t, (l = si(Error(a(424)), n)));
										break e;
									}
									for (
	...
	function i() {
		for (var e, n, t = 0, r = '', l = arguments.length; t < l; t++)
			(e = arguments[t]) && (n = o(e)) && (r && (r += ' '), (r += n));
		return r;
	}
	const u = i,
		s = t.p + 'static/images/7b59a22754045259b902.png',
		c = {
			text: 'index-module__text__s6Dz3',
			'open-sans': 'index-module__open-sans__Hto0O',
			ubuntu: 'index-module__ubuntu__jDAa1',
			'cormorant-garamond': 'index-module__cormorant-garamond__cT7oI',
			'days-one': 'index-module__days-one__iyTRM',
			merriweather: 'index-module__merriweather__a_rDg',
			left: 'index-module__left__mJQb9',
			center: 'index-module__center__EPqET',
			uppercase: 'index-module__uppercase__igGyn',
			size12: 'index-module__size12__LlqKX',
			size18: 'index-module__size18__XKqtq',
			size22: 'index-module__size22__XF8a3',
			size25: 'index-module__size25__z4AKP',
			size31: 'index-module__size31__p1mZG',
			size38: 'index-module__size38__IlbSk',
			size45: 'index-module__size45__tpjHo',
			weight400: 'index-module__weight400__kSljP',
			weight800: 'index-module__weight800__KwAiz',
			normal: 'index-module__normal__I5j2U',
			italic: 'index-module__italic___Aonh',
			dynamic: 'index-module__dynamic__rWXpt',
			dynamicLite: 'index-module__dynamicLite__S3f0s',
		};
	var f = function (e) {
		var n,
			t,
		...
		return (0, r.jsx)(u, { className: E, children: a });
	};
	var d = function (e) {
		return (0, r.jsxs)('article', {
			className: u('Article-module__article__mC2Yg'),
			onClick: e.onClick,
			children: [
				(0, r.jsx)(f, {
					as: 'h1',
					...
					uppercase: !0,
					dynamicLite: !0,
					children: 'Портрет Западной Швейцарии',
				}),
				(0, r.jsx)('div', {
					className: 'Article-module__titleDescription__QhHHg',
					children: (0, r.jsx)(f, {
						size: 22,
						weight: 800,
						uppercase: !0,
				...
				(0, r.jsx)('img', {
					className: 'Article-module__image__O1j3W',
					src: s,
	...
	var p = function (e) {
		...
		return (0, r.jsx)('div', {
			...
			tabIndex: 0,
			className: u(
				'ArrowButton-module__container__j_w67',
				((n = {}),
				(n['ArrowButton-module__container_open__Gcgii'] = e.isOpen),
				n)
			),
			onClick: e.onClick,
			children: (0, r.jsx)('img', {
				src: 'data:image/svg+xml;base64,',
				alt: 'иконка стрелочки',
				className: u(
					((t = {}),
					(t['ArrowButton-module__arrow__Yicih'] = !0),
					(t['ArrowButton-module__arrow_open__mv6Qb'] = e.isOpen),
					t)
				),
			}),
		});
	...
	var m = function (e) {
			...
			return (0, r.jsx)('button', {
				className: i(
					'Button-module__button__mLS_R',
					((n = {}),
					(n['Button-module__button_apply__ngLIk'] = 'apply' === u),
					n),
					((t = {}),
					(t['Button-module__button_clear__P4P0O'] = 'clear' === u),
					t)
				),
				type: o,
				onClick: a,
				children: (0, r.jsx)(f, { weight: 800, uppercase: !0, children: l }),
			});
		},
		h = [
			'open-sans',
		...
		v = [
			{ title: 'Open Sans', value: 'Open Sans', className: h[0] },
			{ title: 'Ubuntu', value: 'Ubuntu', className: h[1] },
			{
				title: 'Cormorant Garamond',
				value: 'Cormorant Garamond',
				className: h[2],
			},
			{ title: 'Days One', value: 'Days One', className: h[3] },
			{ title: 'Merriweather', value: 'Merriweather', className: h[4] },
		],
		g = [
			{
				title: 'Черный',
	...
	const S = {
		selectWrapper: 'Select-module__selectWrapper__r5l79',
		container: 'Select-module__container__KEYBU',
		arrow: 'Select-module__arrow__p5lqL',
		placeholder: 'Select-module__placeholder__bB0Jm',
		select: 'Select-module__select__MwSLA',
		option: 'Select-module__option__VT90b',
		'option-black': 'Select-module__option-black__BbZZ3',
		'option-white': 'Select-module__option-white__KqgJc',
		'option-gray': 'Select-module__option-gray__NIxuX',
		'option-pink': 'Select-module__option-pink__H0f3Y',
		'option-fuchsia': 'Select-module__option-fuchsia__FQ3_Z',
		'option-yellow': 'Select-module__option-yellow__EQ0zy',
		'option-green': 'Select-module__option-green__SkVzf',
		'option-blue': 'Select-module__option-blue__MU2Hw',
		'option-purple': 'Select-module__option-purple__JFtDC',
		'option-wide': 'Select-module__option-wide__mXqiv',
		'option-narrow': 'Select-module__option-narrow__LfALB',
	};
	var x = function (e) {
			var n,
				t = e.option,
			...
			return (
				(function (e) {
					...
					(0, a.useEffect)(
						function () {
							...
							if (e) {
								var l = function (r) {
									document.activeElement === e && 'Enter' === r.key && n(t);
								};
								return (
				...
				})({ optionRef: d, value: l, onClick: c }),
				(0, r.jsx)('li', {
					className: u(S.option, S[i || '']),
					value: l,
					onClick:
						((n = l),
						function () {
					...
					tabIndex: 0,
					'data-testid': 'select-option-'.concat(l),
					ref: d,
					children: (0, r.jsx)(f, { family: _(s) ? s : void 0, children: o }),
				})
			);
		},
		C = function (e) {
			var n,
				...
				v = (0, a.useRef)(null),
				g =
					null !== (n = null == o ? void 0 : o.optionClassName) && void 0 !== n
						? n
						: '';
			return (
				(function (e) {
				...
				})({ isOpen: p, rootRef: h, onClose: s, onChange: m }),
				(function (e) {
					var n = e.placeholderRef,
						t = e.onChange;
				...
				(0, r.jsxs)('div', {
					...
					children: [
						...
						(0, r.jsxs)('div', {
							...
							children: [
								(0, r.jsx)('img', {
									src: 'data:image/svg+xml;base64,',
									alt: 'иконка стрелочки',
									className: S.arrow,
								}),
								(0, r.jsx)('div', {
									className: u(S.placeholder, S[g]),
									'data-status': status,
									'data-selected': !!(null == o ? void 0 : o.value),
									onClick: function () {
										m(function (e) {
											return !e;
										});
									...
									ref: v,
									children: (0, r.jsx)(f, {
										family: _(null == o ? void 0 : o.className)
											? null == o
												? void 0
												: o.className
											: void 0,
										children: (null == o ? void 0 : o.title) || l,
									}),
								}),
								p &&
									(0, r.jsx)('ul', {
										...
										children: t
											.filter(function (e) {
												return (null == o ? void 0 : o.value) !== e.value;
											})
											.map(function (e) {
												return (0, r.jsx)(
													x,
	...
	var E = function (e) {
			...
			var c = ''.concat(o, '_radio_item_with_value__').concat(n),
				d = n === l.title;
			return (0, r.jsxs)(
				'div',
				{
					className: 'RadioGroup-module__item__PXFNR',
					'data-checked': d,
					'data-testid': c,
					tabIndex: 0,
					ref: s,
					children: [
						(0, r.jsx)('input', {
							className: 'RadioGroup-module__input__zCGZ2',
							type: 'radio',
							name: o,
							id: c,
							value: n,
							onChange: function () {
								return null == i ? void 0 : i(u);
							},
							tabIndex: -1,
						}),
						(0, r.jsx)('label', {
							className: 'RadioGroup-module__label__lxT0l',
							htmlFor: c,
							children: (0, r.jsx)(f, { size: 18, uppercase: !0, children: t }),
						}),
					],
				},
				n
		...
		N = function (e) {
			var n = e.name,
				...
				o = e.title;
			return (0, r.jsxs)('div', {
				className: 'RadioGroup-module__container__iiPTO',
				children: [
					o &&
						(0, r.jsx)(r.Fragment, {
							children: (0, r.jsx)(f, {
					...
					(0, r.jsx)('div', {
						className: 'RadioGroup-module__group__JMFhe',
	...
	var z = function () {
		return (0, r.jsx)('div', { className: 'index-module__separator__UZ2ii' });
	};
	var P = function () {
			return (
				(P =
		...
		L = function (e) {
			...
			return (0, r.jsxs)(r.Fragment, {
				children: [
					...
					(0, r.jsx)('aside', {
						className: u(
							'ArticleParamsForm-module__container__c0QkR',
							((n = {}),
							(n['ArticleParamsForm-module__container_open__uiXWh'] = t),
							n)
						),
						children: (0, r.jsxs)('form', {
							className: 'ArticleParamsForm-module__form__f070g',
							onSubmit: function (e) {
								e.preventDefault(), null == o || o(c);
							},
							children: [
								(0, r.jsx)(f, {
									size: 31,
								...
								(0, r.jsx)(C, {
									title: 'шрифт',
									selected: c.fontFamilyOption,
									options: v,
									onChange: h('fontFamilyOption'),
								}),
								(0, r.jsx)(N, {
									title: 'размер шрифта',
									name: 'font-size',
									selected: c.fontSizeOption,
									options: w,
									onChange: h('fontSizeOption'),
								}),
								(0, r.jsx)(C, {
									title: 'цвет шрифта',
									selected: c.fontColor,
									options: g,
									onChange: h('fontColor'),
								}),
								(0, r.jsx)(z, {}),
								(0, r.jsx)(C, {
									title: 'цвет фона',
									selected: c.backgroundColor,
									options: y,
									onChange: h('backgroundColor'),
								}),
								(0, r.jsx)(C, {
									title: 'ширина контента',
									selected: c.contentWidth,
									options: b,
									onChange: h('contentWidth'),
								}),
								(0, r.jsxs)('div', {
									className: 'ArticleParamsForm-module__bottomContainer__iuCWO',
									children: [
										(0, r.jsx)(m, {
											title: 'Сбросить',
											type: 'clear',
										...
										(0, r.jsx)(m, { title: 'Применить', type: 'apply' }),
									],
								}),
							],
						}),
	...
	(0, l.H)(T).render(
		(0, r.jsx)(a.StrictMode, {
			children: (0, r.jsx)(function () {
				var e = (0, a.useState)(k),
					n = e[0],
					t = e[1],
					l = (0, a.useState)(!1),
					o = l[0],
				...
				return (0, r.jsxs)('main', {
					className: u('index-module__main__C4t2m'),
					style: {
						'--font-family': n.fontFamilyOption.value,
						'--font-size': n.fontSizeOption.value,
						'--font-color': n.fontColor.value,
						'--container-width': n.contentWidth.value,
						'--bg-color': n.backgroundColor.value,
					},
					children: [
						(0, r.jsx)(L, {
							formOpen: o,
